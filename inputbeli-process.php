...
if(isset($_POST['Kirim'])){
	...
	// buat query
    if($deterjen > 0) {
        $sql = "INSERT INTO transaksi (Nama_customer, Tanggal, Alamat, No_telp, qty, kode_barang, pencatat) VALUE ('$nama','$tanggal', '$alamat', '$notelp', $deterjen, 'B01', '$karyawan')";
    ...
    if($fsoftener > 0) {
        $sql = "INSERT INTO transaksi (Nama_customer, Tanggal, Alamat, No_telp, qty, kode_barang, pencatat) VALUE ('$nama','$tanggal', '$alamat', '$notelp', $fsoftener, 'B02', '$karyawan')";
    ...
    if($plaundry > 0) {
        $sql = "INSERT INTO transaksi (Nama_customer, Tanggal, Alamat, No_telp, qty, kode_barang, pencatat) VALUE ('$nama','$tanggal', '$alamat', '$notelp', $plaundry, 'B03', '$karyawan')";
