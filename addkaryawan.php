...
<link href="https://fonts.googleapis.com/css?family=Iceland&display=swap" rel="stylesheet">
          ...
          <body style="background-color: rgba(96.15624949336052, 125.81190258264542, 192.31249898672104, 1);;">
            ...
            <div class=e86_76>
                ...
                <div class=e2_151>
                  <div class="e2_142"></div><span  class="e2_150">Tambahkan Akun</span>
                  <form action="addkaryawan-process.php" method="POST">
                    <span  class="e2_145"><label for="username">Username</label></span>
                    <input type="text" class="e2_143" name="username" placeholder="Masukkan username...">
                    <span  class="e2_146"><label for="pwd">Password</label></span>
                    <input type="text" class="e2_144" name="pwd" placeholder="Masukkan password...">
                    <input type="submit" class="e2_285" value="Tambah" name="tambahkan" style="color:rgb(255, 255, 255) ;">
                </form>
                </div>
