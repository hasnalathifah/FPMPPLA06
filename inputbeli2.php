          ...
          <body style="background-color: rgba(96.15624949336052, 125.81190258264542, 192.31249898672104, 1);;">
            <nav class="navbar navbar-expand-lg navbar-light" style="background-color:rgba(1.0000000591389835, 32.00000189244747, 96.00000187754631, 1);">
              <div class="container-fluid">
                <!-- Navbar brand -->
                <!-- <a href="inputbeli.php"><img src="images/back.png" alt="back" width="50px"></a> -->
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  ...
                  <ul class="navbar-nav d-flex flex-row me-1">
                    <li class="nav-item me-3 me-lg-0">
                      <a class="nav-link" href="index.php"><span class="logout" style="color:rgb(255, 255, 255); font-size:20px;">Log Out</span></a>
                    </li>
                    <li class="nav-item me-3 me-lg-0">
            ...
            <div class=e86_81>
                <div class=e2_201>
                  ...
                  <div class="e2_231"></div><span  class="e2_209">Data Pembelian Berhasil Diinput!</span>
                  <a href="kdashboard.php"><span  class="e2_305">Kembali ke menu</span></a>
                </div>
